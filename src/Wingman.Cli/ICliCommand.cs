...
public interface ICliCommand
{
    ...
    /// <summary>
    /// The command's boolean options, such as <c>yes</c> for <c>--yes</c>, which never take a value;
    /// <see cref="CliRunner"/> parses the command line with them before calling <see cref="RunAsync"/>.
    /// </summary>
